...
mlflow.set_experiment("experiment2_rf")
...
with mlflow.start_run(run_name=f"trying  various models"):
    ...
    for model_name, model in models.items():
        with mlflow.start_run(run_name=model_name, nested=True):
            ...
            pickle.dump(model,open(f"notebooks/exp2/{model_filename}.pkl", "wb"))            

            # model = pickle.load(open("notebooks/exp2/model.pkl","rb"))
            ...
            plt.savefig(f"notebooks/exp2/confusion_matrix_{model_name.replace(" ","_")}.png")
            ...
            mlflow.log_artifact(f"notebooks/exp2/confusion_matrix_{model_name.replace(" ","_")}.png")
